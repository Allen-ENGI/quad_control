...
#include "quad_bot_controller/quad_hardware.hpp"
#include <string>
#include <vector>

//define the same name as the pkg name to avoid conflict
namespace quad_bot_controller
{
...
PLUGINLIB_EXPORT_CLASS(
  quad_bot_controller::RobotSystem, hardware_interface::SystemInterface)
